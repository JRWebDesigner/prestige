...
export default function PrVePage() {
  const [prVePerfumes, setPrVePerfumes] = useState<Perfume[]>([]);
  ...
  useEffect(() => {
    const loadPerfumes = async () => {
      try {
        ...
        setPrVePerfumes(allPerfumes.filter(perfume => perfume.autumn || perfume.winter));
      } catch (error) {
